...
public class PollService {
  ...
  public PagedResponse<PollResponse> getAllPolls(UserPrincipal currentUser, int page, int size) {
    ...
    List<PollResponse> pollResponses = polls.map(poll -> {
      return ModelMapper.mapPollEntityToPollResponse(poll, choiceVoteCountMap,
  ...
  public PagedResponse<PollResponse> getPollsCreatedBy(String username, UserPrincipal currentUser,
    ...
    List<PollResponse> pollResponses = polls.map(poll -> {
      return ModelMapper.mapPollEntityToPollResponse(poll, choiceVoteCountMap, user,
          pollUserVoteMap == null ? null : pollUserVoteMap.getOrDefault(poll.getId(), null));
    }).getContent();
  ...
  public PollResponse getPollById(Long pollId, UserPrincipal currentUser) {
    ...
    return ModelMapper.mapPollEntityToPollResponse(poll, choiceVotesMap, creator,
        userVote != null ? userVote.getChoice().getId() : null);
  }

  public PollResponse castVoteAndGetUpdatedPoll(Long pollId, VoteRequest voteRequest,
    ...
    Choice selectedChoice = poll.getChoices().stream()
        .filter(choice -> choice.getId().equals(voteRequest.getChoiceId())).findFirst().orElseThrow(
